			...
			?>
				...
				<form role="form" data-toggle="validator" name="PostForm" action="" method="post" enctype="multipart/form-data" class="form-horizontal">
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<select class="form-control" id="categoriaSelect" name="slider_link">
									...
									<?php extract($album); ?>
										<option <?php if (isset($slider['slider_link']) && $slider['slider_link'] == $album_url) echo 'selected'; ?> value="<?php echo $album_url; ?>"><?php echo $album_nome; ?></option>
									<?php endforeach; ?>
								</select>	
							</div>
							<?php
					...
					<div class="row col-lg-12 text-center">				
						<hr>
						<input type="submit" class="btn btn-success btn-lg" value="Atualizar Slider" name="SendPostForm">
					</div>
				</form>
