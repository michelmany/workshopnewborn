	...
	<div class="col-lg-12">				
		...
		<div class="panel panel-default">	
			<div class="panel-heading">
				<a href="painel.php?exe=slider/create" class="btn btn-turquoise btn-lg"><i class="fa-plus-square"></i> Novo banner</a>
			</div>				
			<div class="panel-body">
				...
				<div class="row">	
					<ul id="sortable">
						...
						$readSlider = new Read;
						$readSlider->ExeRead("nit_slider", "WHERE user_id = '$user_id' ORDER BY slider_order ASC");?>
									...
									<?php else:	?>
										...
										<li class="view view-first sliderImg" id="<?php echo $slider_id ?>">
											...
											<div class="mask">
												...
												<a class="btn btn-danger" onclick="confirm_modal_del_slide('painel.php?exe=slider/index&slider=<?= $slider_id; ?>&action=delete', '<?php echo $slider_title2; ?>');" title="Excluir Slide"><i class="fa-remove"></i></a>
											</div>	
										</li>
				        ...
				        <?php 
				            ...
				            WSErro("Desculpe, nenhum slide cadastrado cadastrado!", WS_INFOR);
				        endif; ?>							
			
					</ul>
				</div>
				<div class="panel-footer">
					<em>Clique na imagem e arraste para ordenar os banners!</em>
				</div>	
			</div>
		</div>
	</div>
