...
<div class="page-title">
	<div class="title-env">
		...
		<p class="description">Gerencie categorias do Blog</p>
	</div>
	<div class="breadcrumb-env">
		<ol class="breadcrumb bc-1" >
			<li><a href="painel.php"><i class="fa-home"></i>Home</a></li>
			<li><a href="painel.php?exe=posts/index">Blog</a></li>
...
<?php # PEGA OS DADOS DOS INPUTS E ENVIA PRO BANCO #
	...
	if(!empty($post['SendPostForm'])):
		...
		require_once('_models/AdminPostCategory.class.php');
		$cadastra = new AdminPostCategory;
...
$read = new Read;
$read->ExeRead('nit_posts_cats', "WHERE user_id = :userid", "userid={$userlogin['user_id']}");
?>
		...
		<div class="table-responsive" data-pattern="priority-columns" data-sticky-table-header="true" data-add-display-all-btn="true">
			<table class="table table-small-font table-striped table-bordered" cellspacing="0" width="100%">
				<thead>
					<tr>
						<th>Nome</th>
						<th width="200" class="text-center">Qtd. de Posts</th>
				...
				<tbody>
					<?php foreach ($read->getResult() as $row): ?>
						...
						<tr>
							...
							<td class="text-center"><?php echo Check::QtdPostsbyCat($category_id); #pega quantidade de posts; ?></td>
							<td>
								
		                        <a class="btn btn-danger" onclick="confirm_modal('painel.php?exe=posts/categorias&delid=<?php echo $category_id; ?>');" data-toggle="tooltip" data-placement="top" title="excluir">
