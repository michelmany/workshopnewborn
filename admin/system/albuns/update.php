			...
			<div class="panel panel-default">
				...
				<div class="panel-body">
		        	...
		        	# Faz A leitura do Banco e mostra os dados na tela
	           		$read = new Read;
	           		$read->ExeRead("nit_albuns", "WHERE album_id = :id AND user_id = :user", "id={$albumid}&user={$userlogin['user_id']}");
					...
					<form name="PostForm" action="" method="post" class="form-horizontal" enctype="multipart/form-data">
						...
						<div class="form-group"> 
							...
							<div class="col-sm-9"> 
								...
								<?php
								$read = new Read;
								$read->ExeRead('nit_albuns_cats', "WHERE user_id = :id", "id={$userlogin['user_id']}");
								?>
