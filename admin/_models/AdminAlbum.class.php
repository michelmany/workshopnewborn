...
class AdminAlbum {
    ...
    public function ExeCreate(array $Data) {
        ...
        $this->UserID = (int) $Data['user_id'];        
            ...
            if ($this->Data['album_capa']):
                $uplaod = new Upload;
                $uplaod->Image($this->Data['album_capa'], 'albumcapa-'.$this->Data['album_url'], null, 'images/albuns');
            endif;
    ...
    public function ExeUpdate($PostId, array $Data) {
        ...
        $this->UserID = (int) $Data['user_id'];     
            ...
            if (is_array($this->Data['album_capa'])):
                ...
                $uploadCapa->Image($this->Data['album_capa'], 'albumcapa-'.$this->Data['album_url'], null, 'images/albuns');
            endif;
    ...
    public function ExeDelete($PostId, $UserID) {
        ...
        $ReadPost = new Read;
        $ReadPost->ExeRead(self::Entity, "WHERE album_id = :post", "post={$this->Post}");
    ...
    private function setData() {
        ...
        $this->Data['album_nome'] = str_replace('&', 'e', $this->Data['album_nome']);
