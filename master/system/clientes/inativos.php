...
<?php # MOSTRA A MENSAGEM DE SUCESSO GRAVADA NA SESSÃO #
	...
	<?php # BUSCO APENAS OS CLIENTES (NIVEL 2) QUE ESTÃO INATIVOS (STATUS=0).
	$read = new Read;
	$read->ExeRead('nit_users', "WHERE user_level = 2 AND user_status = 0");
	?>
			...
			<div class="panel panel-default">
				...
				<div class="panel-body">
					...
					WSErro("Olá, não há clientes inativos cadastrados no sistema! ", WS_INFOR);
					else: ?>
							...
							<?php foreach ($read->getResult() as $row): ?>
								...
								<tr>
									...
									<td>
				                        ...
				                        <a class="btn btn-danger" onclick="confirm_modal('painel.php?exe=clientes/inativos&delid=<?php echo $user_id; ?>');" data-toggle="tooltip" data-placement="top" title="excluir">
