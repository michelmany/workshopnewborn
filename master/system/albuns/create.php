					...
					<div class="panel panel-default">
						...
						<div class="panel-body">
					        ...
					        if (isset($post) && $post['SendPostForm']):
					            $post['album_status'] = ($post['SendPostForm'] == 'Cadastrar' ? '0' : '1' );
							...
							<form name="PostForm" action="" method="post" class="form-horizontal" enctype="multipart/form-data">
								...
								<div class="row col-lg-9 col-md-9 text-center">				
									<input type="submit" class="btn btn-primary btn-lg" value="Cadastrar" name="SendPostForm">
									<input type="submit" class="btn btn-success btn-lg" value="Cadastrar & Publicar" name="SendPostForm">
