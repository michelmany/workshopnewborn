...
<div class="page-title">
	<div class="title-env">
		...
		<p class="description">Preencha informações para o site</p>
	</div>
			...
			<div class="tab-content">
				...
				<?php 	# FAZ A LEITURA NO BANCO E FAZ O LOOP PARA MOSTRAR OS RESULTADOS #
					...
					if (!$read->getResult()):
						...
						WSErro("Olá, não foi possível ler os dados de configuração! ", WS_INFOR);
					else: 
				...
				<div class="tab-pane active" id="tab-1">
					...
					<div class="form-group"> 
						...
						<div class="input-group">
							...
							<input type="text" class="form-control" id="field-1" placeholder="seunomedeusuario" name="user_facebook" value="<?php if(isset($user_facebook)) echo $user_facebook; ?>"> 
						</div> 
						</div>
					</div>
					...
					<div class="form-group"> 
						...
						<div class="input-group">
							...
							<input type="text" class="form-control" id="field-1" placeholder="seunomedeusuario" name="user_twitter" value="<?php if(isset($user_twitter)) echo $user_twitter; ?>"> 
						</div> 
						</div>
					</div>	
					...
					<div class="form-group"> 
						...
						<div class="input-group">
							<span class="input-group-addon">@</span>
							<input type="text" class="form-control" id="field-1" placeholder="seunomedeusuario" name="user_instagram" value="<?php if(isset($user_instagram)) echo $user_instagram; ?>"> 
						</div> 
						</div>
					</div>	
					...
					<div class="form-group"> 
						...
						<div class="input-group">
							<span class="input-group-addon">@</span>
							<input type="text" class="form-control" id="field-1" placeholder="seunomedeusuario" name="user_skype" value="<?php if(isset($user_skype)) echo $user_skype; ?>"> 
						</div> 
						</div>
					</div>																									
					...
					<div class="form-group"> 
						...
						<div class="col-sm-9"> 
							<input type="email" class="form-control" id="field-1" placeholder="" name="user_email_destino" value="<?php if(isset($user_email_destino)) echo $user_email_destino; ?>" required="required"> 
					...
					<form name="formSobre" action="" method="post" class="form-horizontal" enctype="multipart/form-data">
						...
						<div class="form-group"> 
							...
							<div class="input-group">
								...
								<input type="text" class="form-control" id="field-1" placeholder="8858540" name="user_video" value="<?php if (isset($user_video)) echo $user_video; ?>"> 
							</div> 
							</div>
						</div>	
				...
				<div class="tab-pane" id="tab-3">
					...
					<form name="formContato" action="" method="post" class="form-horizontal j_btn_salva_Configs">		
						...
						<div class="form-group"> 
							...
							<div class="col-sm-9"> 
								<input type="email" class="form-control" id="field-1" placeholder="" name="user_email" value="<?= $user_email_contato = ( !empty($user_email) ? $user_email : $userlogin['user_email'] ); ?>"> 
							</div> 
						</div>					
						...
						<div class="form-group"> 
							...
							<div class="col-sm-9"> 
								<input type="text" class="form-control" id="field-1" placeholder="" name="user_telefone" value="<?php if (!empty($user_telefone)) echo $user_telefone; ?>"> 
							</div> 
						</div>
						...
						<div class="form-group"> 
							...
							<div class="col-sm-9"> 
								<input type="text" class="form-control" id="field-1" placeholder="" name="user_telefone2" value="<?php if (!empty($user_telefone2)) echo $user_telefone2; ?>"> 
							</div> 
						</div>		
						...
						<div class="form-group"> 
							...
							<div class="col-sm-9"> 
								<input type="text" class="form-control" id="field-1" placeholder="" name="user_celular" value="<?php if (!empty($user_celular)) echo $user_celular; ?>"> 
							</div> 
						</div>														
						...
						<div class="form-group"> 
							...
							<div class="col-sm-9"> 
								<input type="text" class="form-control" id="field-1" placeholder="" name="user_endereco" value="<?php if (!empty($user_endereco)) echo $user_endereco; ?>"> 
							</div> 
						</div>	
						...
						<div class="form-group"> 
							...
							<div class="col-sm-9"> 
								<input type="text" class="form-control" id="field-1" placeholder="" name="user_comple" value="<?php if (!empty($user_comple)) echo $user_comple; ?>"> 
							</div> 
						</div>		
						...
						<div class="form-group"> 
							...
							<div class="col-sm-9"> 
								<input type="text" class="form-control" id="field-1" placeholder="" name="user_cidade" value="<?php if (!empty($user_cidade)) echo $user_cidade; ?>"> 
							</div> 
						</div>																													
				...
				<div class="tab-pane" id="tab-4">
					...
					<form name="formSeo" action="" method="post" class="form-horizontal j_btn_salva_Configs">		
						...
						<div class="form-group"> 
							...
							<div class="col-sm-9"> 
								<input type="text" class="form-control" id="field-1" placeholder="" maxlength="70" name="user_sitename" value="<?php if (isset($user_sitename)) echo ($user_sitename); ?>"> 
