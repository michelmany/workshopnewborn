...
# Depois tenho que pensar numa maneira de salvar as outras duas (geral e sobre) via akax também.
...
if ($Post):
	...
	$Update = new Update;
	$Update->ExeUpdate('nit_site_config', $Post, "WHERE user_id = :userid", "userid={$userlogin['user_id']}");
