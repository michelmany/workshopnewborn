...
<head>
	...
	<title>Retratum | Painel de Gerenciamento de conteúdo</title>
					...
					<div class="user-info">						
						...
						<div class="user-details">							
							...
							<div class="user-links">
								<a href="extra-profile.html" class="btn btn-success">Editar Perfil</a>
							</div>
		...
		<div class="sidebar-menu toggle-others fixed">
			...
			<div class="sidebar-menu-inner">
				...
				<ul id="main-menu" class="main-menu">
					...
					<li class="<?php if (in_array('clientes', $linkto)) echo 'active opened'; ?> auto-inherit-active-class">
						<a href="">
						...
						<ul>
							<li>
								<a href="painel.php?exe=clientes/index">
									<span class="title">Clientes Ativos</span>
								</a>
							</li>
							<li>
								<a href="painel.php?exe=clientes/inativos">
									<span class="title">Clientes Inativos</span>
								</a>
							</li>							
						</ul>
					</li>					
					<li class="<?php if (in_array('temas', $linkto)) echo ' active'; ?>">
						<a href="painel.php?exe=temas/index">
			...
			<footer class="main-footer sticky footer-type-1">				
				<div class="footer-inner">
					...
					<div class="footer-text">
						 <?php echo date('Y'); ?> &copy; <a href="http://retratum.com" target="_blank"><strong>Retratum.com</strong></a>
						<!-- desenvolvido pela <a href="http://nitdesign.com.br" target="_blank">NITDESIGN</a> -->
					</div>
