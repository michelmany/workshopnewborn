...
<head>
	...
	<title>Retratum - Painel Master</title>
...
<body class="page-body login-page login-light">
	<div class="login-container">
		<div class="row">
			<div class="col-sm-6">
				<img src="assets/images/logo@2x.png"><br><br><br>
				<?php # Faz a verificação do usuário e redireciona para o painel se acesso estiver ok -->
	                $login = new Login(3); #aqui tem que estar com (3).
	                if ($login->CheckLogin()):
				...
				<form method="post" action="" name="AdminLoginForm" role="form" id="login" class="login-form fade-in-effect">
					...
					<div class="form-group">
						<input type="submit" name="AdminLogin" value="Entrar" class="btn btn-pink btn-block btn-lg" />
					</div>
