...
class View {
    ...
    #editei essa parte aqui adicionando as condições para que carregue tanto no lado do cliente, tanto no lado da index.
    
    public function Load($Template) {
        if (file_exists(REQUIRE_PATH . DIRECTORY_SEPARATOR . '_tpl' . DIRECTORY_SEPARATOR . (string) $Template . '.tpl.html')):
        ...
        elseif (file_exists(REQUIRE_PATH_USER . DIRECTORY_SEPARATOR . '_tpl' . DIRECTORY_SEPARATOR . (string) $Template . '.tpl.html')):
            $this->Template = REQUIRE_PATH_USER . DIRECTORY_SEPARATOR . '_tpl' . DIRECTORY_SEPARATOR . (string) $Template;
            $this->Template = file_get_contents($this->Template . '.tpl.html');
        endif;
