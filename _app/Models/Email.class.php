...
class Email {
    ...
    private function setMail() {
        ...
        $this->RemetenteCidade = $this->Data['RemetenteCidade'];
        $this->DataEvento = $this->Data['DataEvento'];
        $this->LocalEvento = $this->Data['LocalEvento'];
    ...
    private function setMsg() {
        $this->Mensagem = "
        <strong>Nome:</strong> {$this->RemetenteNome}<br><br>
        <strong>Email:</strong> {$this->RemetenteEmail}<br><br>
        <strong>Telefone:</strong> {$this->RemetenteTelefone}<br><br>
        <strong>Cidade:</strong> {$this->RemetenteCidade}<br><br>
        <strong>Data do Evento:</strong> {$this->DataEvento}<br><br>
        <strong>Local do Evento:</strong> {$this->LocalEvento}<br><br>
        <strong>Mensagem:</strong> {$this->Mensagem}<br><br>
        <hr>
    ...
    private function sendMail() {
        if ($this->Mail->Send()):
            $this->Error = ['Obrigado por entrar em contato!', WS_ACCEPT];
            $this->Result = true;
        else:
