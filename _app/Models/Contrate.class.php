<?php
/**
 * Contrate.class [ MODEL ]
 * Responsável por cadastrar os usuários vindo do formulário de CONTRATE no site.
 * 
...
class Contrate {
    ...
    private function setData() {
        unset($this->Data['domain']); //unset no checkbox
    ...
    private function Create() {
        ...
        if ($Create->getResult()):
            ...
            $_SESSION['sucesso'] = "<b>{$this->Data['user_fullname']}</b>, seu cadastro foi efetuado com sucesso!";    
